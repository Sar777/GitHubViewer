...
public class ListRepositoriesTransformer implements ITransformer<List<Repository>> {
    ...
    public List<Repository> transform(Object object) {
        ...
        for (int i = 0; i < jsonArray.length(); ++i)
            try {
                repositories.add(new RepositoryTransformer().transform(jsonArray.getJSONObject(i)));
            } catch (JSONException e) {

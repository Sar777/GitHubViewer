...
public class EventCommitTransformer implements ITransformer<EventCommit> {
    private static final String TAG = "EventCommitTransformer";
    ...
    @Override
    public EventCommit transform(Object object) {
